...
- 任何 V2 可见 UI 先读 `docs/product/design-system.md`；当前主导航是 `今日 / 饮食 / 日历 / 小窝 / 我的`。
...
4. 未运行的检查及原因
5. 风险 / 未完成事项
6. 是否需要同步 `CHANGELOG.md` 和 `docs/engineering/current-state.md`
