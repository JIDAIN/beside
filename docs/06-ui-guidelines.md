...
- 标准七列月历；
- 顶部固定提供心情 / 饮食 / 睡眠切换；
- 我 / Ta 切换位于“月度回顾”标题行最右侧，仅饮食和睡眠显示；
- 三个视图统一使用心情月历的纸张背景和无独立卡框日期布局；
- 心情同日显示双人记录；饮食和睡眠只显示我 / Ta 当前选中的一人；
- 饮食圆块固定暖色，睡眠圆块固定紫蓝色；我 / Ta 切换不得改变领域色板；
- 圆块大小表达月内变化，格内同时直接显示 kcal / 小时，不使用好坏评价；
- 点击日期进入详情；
- 日期详情复用今日的心情、睡眠和活动编辑器；当前账号可维护自己的历史事实，Ta 的个人事实仍只读；
- 历史活动新增必须让 `activity_date` 与 `occurred_at` 落在所选业务日期，不能误写成操作当天；
- 历史饮食入口必须保留所选日期，保存 / 删除后仍返回该日期；
- 详情回顾心情、睡眠、活动、饮食概览；
- 不做绩效式打卡评价。

饮食页把我 / Ta 切换放在页面标题右侧，不再单独占据整行；每条加餐以独立卡片展示自己的时间、照片、明细、营养和编辑入口，同一时段多次加餐不得合并成单张照片。
