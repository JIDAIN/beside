...
> 当时架构基线：`docs/architecture/ai/access-core.md`；该 current 文档现已合并为 [AI Architecture](../../architecture/ai/architecture.md)。
...
- 当前对应入口：[AI Architecture](../../architecture/ai/architecture.md)
- 本决策日志
