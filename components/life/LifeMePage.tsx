    ...
    <AppPageShell title="我的">
      {loading ? <section className="life-surface life-section-card text-sm text-[var(--life-text-muted)]">正在确认登录状态…</section> : !authenticated || !currentPartnerKey ? (
        ...
        <div className="grid gap-3">
          <section className="life-account-hero life-account-hero-v3"><div className="life-account-avatar" aria-hidden>{accountIcon}</div><div className="min-w-0 flex-1"><p className="text-lg font-black text-[var(--life-text)]">我的小岛</p></div></section>
